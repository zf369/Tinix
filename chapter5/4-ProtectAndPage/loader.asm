...
PageDirBase        equ    100000h ; PDE的开始地址：0x100000h(1M)
PageTblBase        equ    101000h ; PTE的开始地址：0x101000h(1M + 4k)
...
LABEL_PM_START:
    ...
    ; >>>>>>> TODO: 这一句正式跳转到已加载到内存中的 KERNEL.BIN 的开始处，开始执行 KERNEL.BIN 的代码
    ; loader 的使命到此结束
    jmp    $
