...
LABEL_BEGIN:
        ...
        mov    es, ax
        mov    ss, ax
        mov    sp, 07c00h       ; TODO: 改成boot是否需要修改sp?
...
LABEL_SEG_CODE32:
        ...
        mov    edi, (80 * 20 + 5) * 2    ; 屏幕第 10 行, 第 0 列。
...
LABEL_LEN_S32    equ ($-$$)  ; S32 Length

;LABEL_LEN_TOTAL    equ    ($ - LABEL_START_0)    ; 总长度


;这段代码完全是凑出来的，因为不-7，编译后的代码是519个字节
times   510-(LABEL_LEN_GDT + LABEL_LEN_S16 + LABEL_LEN_S32) - 7  db 0    
